...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C7Mloxwk.mjs')
  }
];
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-63095c74"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DxDZ5Uhp.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C-kSp6x6.mjs'));
