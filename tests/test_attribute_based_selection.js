...
const mockAssets = [
  {
    ...
    ai_description: 'A family of four is enjoying a perfect summer day at the beach. The children are building sandcastles while the parents relax nearby. The scene captures the joy and relaxation of a family vacation with clear blue skies and gentle ocean waves in the background.',
  ...
  },
  {
    ...
    ai_description: 'A father and son are hiking along a scenic mountain trail with breathtaking panoramic views of the Rocky Mountains. The trail winds through alpine meadows and offers spectacular vistas of snow-capped peaks in the distance.',
  ...
  },
  {
    ...
    ai_description: 'A lively birthday party scene with a 10-year-old girl named Sarah surrounded by family and friends. The room is decorated with colorful balloons and streamers, and there\'s a beautifully decorated birthday cake on the table. Everyone is smiling and celebrating this special milestone.',
  ...
  },
  {
    ...
    ai_description: 'A warm and festive Christmas dinner scene with multiple generations of family gathered around a beautifully set dinner table. The table is adorned with traditional holiday decorations, and everyone is sharing a meal together, creating a heartwarming family moment.',
  ...
  },
  {
    ...
    ai_description: 'A proud high school graduation ceremony scene with a student wearing a traditional cap and gown. The student is surrounded by proud parents and teachers, all celebrating this significant academic achievement. The atmosphere is filled with joy and accomplishment.',
  ...
  },
  {
    ...
    ai_description: 'A stunning panoramic view of the iconic Chicago skyline taken from Lake Michigan. The photograph captures the impressive architecture of downtown Chicago with its famous skyscrapers reflecting beautifully in the calm waters of the lake.',
  ...
  },
  {
    ...
    ai_description: 'A family is posing in front of the famous Cloud Gate sculpture, also known as "The Bean," in Millennium Park. The reflective surface of the sculpture creates interesting distorted reflections of the family and the surrounding Chicago skyline.',
